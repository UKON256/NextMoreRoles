...
namespace NextMoreRoles.Patches.HarmonyPatches.Meeting
{
    ...
    static class MeetingHud_Awake
    {
        ...
        static void Postfix(MeetingHud __instance)
        {
            ...
            NextMoreRoles.Modules.DatasManager.MeetingDatas.IsMeeting = true;                                                //ミーティング中かどうかのフラグを変える
    ...
    class MeetingHud_CheckForEndVoting
    {
        ...
        static void Postfix()
        {
            NextMoreRoles.Modules.DatasManager.MeetingDatas.IsMeeting = false;                                               //ミーティング中かどうかのフラグを変える
        }
    }
}
