...
using NextMoreRoles.Patches.SystemPatches;
using UnityEngine;
...
namespace NextMoreRoles.Modules
{
    public class ModTranslation
    {
        ...
        public static void Load()
        {
            ...
            Stream stream = assembly.GetManifestResourceStream("NextMoreRoles.Resources.TranslateDatas.json");
        ...
        public static Sprite getImage(string key, float pixelsPerUnit)
        {
            key = key.Replace("/", ".");
            key = key.Replace("\\", ".");
            key = "NextMoreRoles.Resources." + key;
